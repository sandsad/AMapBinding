...
namespace AMapSearchKit
{
	...
	[BaseType(typeof(AMapSearchObject))]
	interface AMapFutureTimeInfoElement
	{
		// @property (assign, nonatomic) NSInteger duration;
		[Export("duration")]
		nint Duration { get; set; }

		// @property (assign, nonatomic) NSInteger pathindex;
		[Export("pathindex")]
		nint Pathindex { get; set; }
	...
	interface AMapFutureTimeInfo
	{
		...
		AMapFutureTimeInfoElement[] Elements { get; set; }
	}
	...
	interface AMapDistanceResult
	{
		...
		[Export("originID")]
		nint OriginID { get; set; }

		// @property (assign, nonatomic) NSInteger destID;
		[Export("destID")]
		nint DestID { get; set; }
	...
	interface AMapCloudPOI
	{
		...
		// @property (nonatomic, strong) NSArray<AMapCloudImage *> * images __attribute__((deprecated("已废弃 since 7.4.0")));
		[Export("images", ArgumentSemantic.Strong)]
	...
	interface AMapPOIAroundSearchRequest
	{
		...
		// @property (assign, nonatomic) BOOL special;
		[Export("special")]
	...
	interface AMapDistrictSearchRequest
	{
		...
		// @property (assign, nonatomic) NSInteger subdistrict;
		[Export("subdistrict")]
		nint Subdistrict { get; set; }
	}
	...
	interface AMapDrivingRouteSearchRequest
	{
		...
		// @property (assign, nonatomic) NSInteger ferry;
		[Export("ferry")]
		nint Ferry { get; set; }

		// @property (assign, nonatomic) NSInteger cartype;
		[Export("cartype")]
		nint Cartype { get; set; }

		// @property (assign, nonatomic) AMapDrivingRouteExcludeType exclude;
		[Export("exclude", ArgumentSemantic.Assign)]
		AMapDrivingRouteExcludeType Exclude { get; set; }
	}
	...
	[BaseType(typeof(AMapRouteSearchBaseRequest))]
	interface AMapTruckRouteSearchRequest
	{
		// @property (assign, nonatomic) NSInteger strategy;
		[Export("strategy")]
		nint Strategy { get; set; }
		...
		// @property (assign, nonatomic) AMapTruckSizeType size;
		[Export("size", ArgumentSemantic.Assign)]
		AMapTruckSizeType Size { get; set; }
		...
		// @property (assign, nonatomic) NSInteger axis;
		[Export("axis")]
		nint Axis { get; set; }
	...
	[BaseType(typeof(AMapSearchObject))]
	interface AMapDistanceSearchRequest
	{
		// @property (nonatomic, strong) NSArray<AMapGeoPoint *> * origins;
		[Export("origins", ArgumentSemantic.Strong)]
		AMapGeoPoint[] Origins { get; set; }

		// @property (nonatomic, strong) AMapGeoPoint * destination;
		[Export("destination", ArgumentSemantic.Strong)]
		AMapGeoPoint Destination { get; set; }

		// @property (assign, nonatomic) AMapDistanceSearchType type;
		[Export("type", ArgumentSemantic.Assign)]
		AMapDistanceSearchType Type { get; set; }
	...
	[BaseType(typeof(AMapRouteSearchBaseRequest))]
	interface AMapFutureRouteSearchRequest
	{
	...
	[BaseType(typeof(AMapSearchObject))]
	interface AMapFutureRouteSearchResponse
	{
		// @property (nonatomic, strong) NSArray<AMapPath *> * paths;
		[Export("paths", ArgumentSemantic.Strong)]
		AMapPath[] Paths { get; set; }
		...
		[Export("timeInfos", ArgumentSemantic.Strong)]
		AMapFutureTimeInfo[] TimeInfos { get; set; }
	}
	...
	interface AMapSearchDelegate
	{
		...
		// @optional -(void)onFutureRouteSearchDone:(AMapRouteSearchBaseRequest *)request response:(AMapFutureRouteSearchResponse *)response;
		[Export("onFutureRouteSearchDone:response:")]
		void OnFutureRouteSearchDone(AMapRouteSearchBaseRequest request, AMapFutureRouteSearchResponse response);

		// @optional -(void)onDistanceSearchDone:(AMapDistanceSearchRequest *)request response:(AMapDistanceSearchResponse *)response;
		[Export("onDistanceSearchDone:response:")]
		void OnDistanceSearchDone(AMapDistanceSearchRequest request, AMapDistanceSearchResponse response);
	...
	interface AMapNearbySearchManager
	{
		...
		// -(BOOL)uploadNearbyInfo:(AMapNearbyUploadInfo *)info __attribute__((deprecated("已废弃 since 7.4.0，该功能不再支持")));
		[Export("uploadNearbyInfo:")]
		bool UploadNearbyInfo(AMapNearbyUploadInfo info);

		// -(BOOL)clearUserInfoWithID:(NSString *)userID __attribute__((deprecated("已废弃 since 7.4.0，该功能不再支持")));
