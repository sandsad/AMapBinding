...
namespace AMapSearchKit
{
	...
	[Native]
	public enum AMapDrivingRouteExcludeType : long
	{
		None = 0,
		Toll = 1,
		Motorway = 2,
	...
	[Native]
	public enum AMapDistanceSearchType : long
	{
		Straight = 0,
		Drive = 1,
		Walk = 3
	...
	public enum AMapSearchErrorCode : long
	{
		...
		Cancelled = 1807,
		OverPassPointCount = 1809,
		OverPassAreaMaxCount = 1810,
		OverPassAreaMaxArea = 1811,
		OverPassAreaPointCount = 1812,
		OverPassKeyWordLenth = 1813,
