...
namespace MAMapKit {
	...
	[Flags]
	[Native]
	public enum MAMapRectCorner : long {
		TopLeft = 1L << 0,
		TopRight = 1L << 1,
		BottomLeft = 1L << 2,
		BottomRight = 1L << 3,
	...
	public static partial class CFunctions {
		...
		[DllImport("__Internal")]
		//[Verify(PlatformInvoke)]
		public static extern MACoordinateRegion MACoordinateRegionMakeWithDistance(CLLocationCoordinate2D centerCoordinate, double latitudinalMeters, double longitudinalMeters);

		// extern MAMapPoint MAMapPointForCoordinate (CLLocationCoordinate2D coordinate);
		[DllImport("__Internal")]
		//[Verify(PlatformInvoke)]
		public static extern MAMapPoint MAMapPointForCoordinate(CLLocationCoordinate2D coordinate);
		...
		[DllImport("__Internal")]
		//[Verify(PlatformInvoke)]
		extern static bool MACircleContainsCoordinate(CLLocationCoordinate2D point, CLLocationCoordinate2D center, double radius);
		...
		[DllImport("__Internal")]
		//[Verify(PlatformInvoke)]
		public static extern unsafe bool MAPolygonContainsPoint(MAMapPoint point, IntPtr polygon, nuint count);

		public static unsafe bool MAPolygonContainsPoint(MAMapPoint point, MAMapPoint[] polygon, nuint count) {
			bool result = false;
			fixed (void* arrPtr = polygon) {
				IntPtr ptr = new IntPtr(arrPtr);
				result = CFunctions.MAPolygonContainsPoint(point, ptr, count);
			}
			return result;
		}
		...
		[DllImport("__Internal")]
		//[Verify(PlatformInvoke)]
		public static extern unsafe bool MAPolygonContainsCoordinate(CLLocationCoordinate2D point, CLLocationCoordinate2D polygon, nuint count);
		...
		//[DllImport("__Internal")]
		//[Verify(PlatformInvoke)]
		//static extern MAPathShowRange MAPathShowRangeMake(float begin, float end);
	}
