...
*/
	...
	interface MAOverlayRenderer {
		// TODO: MAOverlayRenderer.RendererDelegate (MAOverlayRenderDelegate)
		...
		//[Verify(MethodToProperty)]
		//MTLRenderCommandEncoder CommandEncoder { get; }
	...
	[BaseType(typeof(MAShape))]
	interface MACustomBuildingOverlay {
	...
	interface MAPolyline {
		...
		unsafe MAPolyline PolylineWithCoordinates(ref CLLocationCoordinate2D coords, nuint count);
	...
	[BaseType(typeof(MAShape))]
	interface MAHeatMapVectorOverlay {
	...
	interface MAMapView_UserLocation {
		...
		[Export("distanceFilter")]
		double SetDistanceFilter(double distanceFilter);

		// @property (nonatomic) CLLocationAccuracy desiredAccuracy;
		[Export("desiredAccuracy")]
		double DesiredAccuracy();
		[Export("desiredAccuracy")]
		double SetDesiredAccuracy(double desiredAccuracy);
	...
	interface MAMapViewDelegate {
		...
		void MapViewRegionWillChangeAnimated(MAMapView mapView, bool animated, bool wasUserAction);
		...
		void MapViewregionDidChangeAnimatedWasUserAction(MAMapView mapView, bool animated, bool wasUserAction);
		...
		void MapView2(MAMapView mapView, MAAnnotationView view);
	...
	[BaseType(typeof(NSObject))]
	interface MAMultiPointItem : INSCopying {
		// @property (assign, nonatomic) CLLocationCoordinate2D coordinate;
		[Export("coordinate", ArgumentSemantic.Assign)]
		CLLocationCoordinate2D Coordinate { get; set; }
...
*/
	...
	[BaseType(typeof(NSObject))]
	interface MAParticleRandomVelocityGenerate {
...
*/
	...
	[BaseType(typeof(NSObject))]
	interface MAParticleRandomColorGenerate {
...
*/
	...
	[BaseType(typeof(NSObject))]
	interface MAParticleCurveSizeGenerate {
...
*/
	...
	[BaseType(typeof(NSObject))]
	interface MAParticleSinglePointShapeModule {
	...
	[BaseType(typeof(NSObject))]
	interface MAParticleRectShapeModule {
	...
	interface MAPolygon : MAOverlay {
		...
		unsafe MAPolygon PolygonWithCoordinates(IntPtr coords, nuint count);
